...
namespace _5Mart2024.Models;

public partial class GoncacompanydbContext : DbContext
{
    public GoncacompanydbContext()
    {
    }

    public GoncacompanydbContext(DbContextOptions<GoncacompanydbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<VwTdSangecenler> VwTdSangecenlers { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=ANK-YZLMORT-01\\MSSQLSERVERANK16;database=GONCACOMPANYDB;trusted_connection=true;trustservercertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VwTdSangecenler>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_TD_SANGecenler");
